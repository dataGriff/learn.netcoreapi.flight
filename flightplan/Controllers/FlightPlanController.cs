...
{
    [Route("api/v1/flightplan")] //this is the base route
    [ApiController]
    public class FlightPlanController : ControllerBase
    {
       ...
       // [SwaggerResponse((int)HttpStatusCode.NoContent, "No flight plans have been filed with this system")]
        public async Task<IActionResult> FlightPlanList()
        {
            ...
            return Ok(flightPlanList); //so status code allows you to pass in an object thus returning that as well as the status code
        }
